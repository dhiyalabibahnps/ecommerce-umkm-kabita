...
class ShopResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'logo' => $this->logo ? (str_starts_with($this->logo, 'http://') || str_starts_with($this->logo, 'https://') ? $this->logo : asset('storage/' . $this->logo)) : null,
            'banner' => $this->banner ? (str_starts_with($this->banner, 'http://') || str_starts_with($this->banner, 'https://') ? $this->banner : asset('storage/' . $this->banner)) : null,
            'status' => $this->status,
