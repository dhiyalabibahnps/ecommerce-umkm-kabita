...
<template>
  <Dialog :visible="visible" modal :showHeader="false" :style="{ width: '28rem' }"
    ...
    <div v-if="shop" class="bg-white rounded-2xl relative">
      <div class="flex items-center justify-between p-4 border-b border-slate-100">
        <h3 class="font-bold text-slate-800 text-lg">Konfirmasi Toko</h3>
      ...
      <div class="p-8 text-center flex flex-col items-center">
        ...
        <p class="text-slate-600 text-sm leading-relaxed">
          Apakah Anda yakin ingin menyetujui verifikasi untuk <br />
      ...
      <div class="p-4 border-t border-slate-100 flex justify-end gap-3 bg-slate-50/50">
        <Button label="Batal" outlined class="border-blue-200! text-blue-600! px-5! bg-white!"
