...
const categories = [
  { label: 'Foto Produk Tidak Jelas / Tidak Sesuai', value: 'foto_invalid' },
  { label: 'Informasi Harga / Deskripsi Tidak Sesuai', value: 'deskripsi_invalid' },
  { label: 'Barang Terlarang / Melanggar Kebijakan', value: 'pelanggaran' }
]
    ...
    <div class="bg-white rounded-2xl relative">
      <div class="flex items-center justify-between p-4 border-b border-slate-100">
        <div class="flex items-center gap-2 text-red-600 font-bold text-lg">
          ...
          <span>Tolak Verifikasi Produk</span>
        </div>
      ...
      <div class="p-6 space-y-4">
        <p class="text-xs text-slate-500 leading-relaxed mb-4">
          Anda akan menolak pengajuan produk ini. Silakan berikan alasan yang jelas agar seller dapat memeperbaiki
          pengajuannya.
        </p>
        ...
        <div>
          ...
          <Textarea v-model="rejectionDetail" rows="4"
            placeholder="Jelaskan secara spesifik apa yang kurang atau salah dari pengajuan produk ini..."
